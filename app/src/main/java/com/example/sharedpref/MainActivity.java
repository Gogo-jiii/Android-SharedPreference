...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("TAG",
                String.valueOf(sharedPref.read("string", SharedPref.DATA_TYPE_STRING).getPrefString()));
        Log.d("TAG", String.valueOf(sharedPref.read("int", SharedPref.DATA_TYPE_INT).getPrefInt()));
        Log.d("TAG",
                String.valueOf(sharedPref.read("float", SharedPref.DATA_TYPE_FLOAT).getPrefFloat()));
        Log.d("TAG",
                String.valueOf(sharedPref.read("long", SharedPref.DATA_TYPE_LONG).getPrefLong()));
        Log.d("TAG",
                String.valueOf(sharedPref.read("boolean", SharedPref.DATA_TYPE_BOOLEAN).isPrefBoolean()));
